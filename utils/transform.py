...
class Transform():
    ...
    - Blurring
    - Sharpening
    After the application of the transformation, a crop of the image is applied. The purpose of the crop is to provide both robustness
    ...
    def __init__(self, p:float = 0.5, scale:float=0.8,
                 ...
                 SEED:int = 30347, cropping_mode:int = GLOBAL_CROP):
...
if __name__ == "__main__":
    ...
    for i in range(N):
        trf = Transform(p=1, scale=1,cropping_mode=Transform.LOCAL_CROP)
        output_image=trf.apply_transform(input_image)
        save_image(output_image,'outputs/output_image'+ str(i)+'.jpg')
    pass
