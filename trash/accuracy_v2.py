...
if __name__ == "__main__":
    ...
    classifier = v2()
    classifier.load_state_dict(state_dict_adapter(torch.load(f'/work/cvcs2024/VisionWise/weights/checkpoint_rescbam_class_r1_{iteration_index}.pth',weights_only=False)['model'],string_to_remove='module.'))
...
#ACC AT ITER 4'900 = 95.62352941176471%