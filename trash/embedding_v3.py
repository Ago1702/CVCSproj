...
if __name__ == "__main__":
    ...
    embedder = v3()
    embedder.load_state_dict(state_dict_adapter(torch.load(f'/work/cvcs2024/VisionWise/weights/checkpoint_rescbam_contr_r1_{iteration_index}.pth',weights_only=False)['model'],string_to_remove='module.'))
    ...
    plt.savefig(os.path.expanduser(f'~/CVCSproj/outputs/rescbam_contr_r1_{iteration_index}.png'))
    plt.close()
